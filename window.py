...
class Window():
    ...
    def run_window(self):
        ...
        prime_button = Button(20, 20, 100, 100, RED, 'Prime95', self.prime_button_action)
        b2 = Button(140, 20, 100, 100, RED, 'n', self.prime_button_action)
        buttons_list = [prime_button, b2]
...
class Button():
    def __init__(self, x, y, width, height, color=(255, 255, 255), text='', on_click_action=None):
        self.x = x
        self.y = y
        self.width = width
        self.height = height
